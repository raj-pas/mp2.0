...
**Last updated:** 2026-05-03 (Phase 8 release-essentials shipped + tagged `v0.1.0-pilot`; starter prompt for next sub-session committed)
**Branch:** `feature/ux-rebuild` (cut from `main` for the v36 UI/UX rewrite per locked decision #9)
**HEAD:** `8259278` (starter prompt for next sub-session) — Tag `v0.1.0-pilot` at `d2abfa1`
