...
**Last updated:** 2026-05-03 (sub-session #1: Phase 5b.3 + 5b.8 shipped; failed-doc CTA polish + session-interruption upload-recovery)
**Branch:** `feature/ux-rebuild` (cut from `main` for the v36 UI/UX rewrite per locked decision #9)
**HEAD:** `72008eb` (Phase 5b.8 session-interruption recovery) — Tag `v0.1.0-pilot` at `d2abfa1`
